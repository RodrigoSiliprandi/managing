...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { nome: @disciplina.nome, perido: @disciplina.perido, professor_id: @disciplina.professor_id } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { nome: @disciplina.nome, perido: @disciplina.perido, professor_id: @disciplina.professor_id } }
