...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { documento: @aluno.documento, endereco_id: @aluno.endereco_id, mae: @aluno.mae, nome: @aluno.nome, pai: @aluno.pai, telefone: @aluno.telefone } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { documento: @aluno.documento, endereco_id: @aluno.endereco_id, mae: @aluno.mae, nome: @aluno.nome, pai: @aluno.pai, telefone: @aluno.telefone } }
