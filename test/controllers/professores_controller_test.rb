...
class ProfessoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professores_url, params: { professor: { documento: @professor.documento, email: @professor.email, endereco_id: @professor.endereco_id, nome: @professor.nome, telefone: @professor.telefone } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { documento: @professor.documento, email: @professor.email, endereco_id: @professor.endereco_id, nome: @professor.nome, telefone: @professor.telefone } }
