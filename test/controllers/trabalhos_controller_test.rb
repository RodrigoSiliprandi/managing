...
class TrabalhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabalho" do
    assert_difference('Trabalho.count') do
      post trabalhos_url, params: { trabalho: { data_de_entrega: @trabalho.data_de_entrega, descricao: @trabalho.descricao, disciplina_id: @trabalho.disciplina_id } }
    end
  ...
  test "should update trabalho" do
    patch trabalho_url(@trabalho), params: { trabalho: { data_de_entrega: @trabalho.data_de_entrega, descricao: @trabalho.descricao, disciplina_id: @trabalho.disciplina_id } }
