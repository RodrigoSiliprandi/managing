...
class AulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aula" do
    assert_difference('Aula.count') do
      post aulas_url, params: { aula: { data: @aula.data, disciplina_id: @aula.disciplina_id, objetivo: @aula.objetivo, realizado: @aula.realizado } }
    end
  ...
  test "should update aula" do
    patch aula_url(@aula), params: { aula: { data: @aula.data, disciplina_id: @aula.disciplina_id, objetivo: @aula.objetivo, realizado: @aula.realizado } }
